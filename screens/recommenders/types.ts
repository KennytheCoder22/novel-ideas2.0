...
export type RecommendationResult = {
  ...
  debugGcdDispatchTrace?: {
    ...
    comicVineEnabledAtRequestStart?: boolean;
    comicVineShouldUseResult?: boolean;
    comicVineDispatchPlanned?: boolean;
    comicVineDispatchAttempted?: boolean;
    comicVineDispatchSkippedReason?: string;
    comicVineQueriesPlanned?: string[];
    comicVineQueriesAttempted?: string[];
  ...
  diversityMemoryHitTitles?: string[];
  diversityMemoryHitRoots?: string[];
  diversityPenaltyStage?: string;
  diversitySuppressionStage?: string;
  diversityMemorySessionSize?: number;
  repeatPenaltyCandidateCount?: number;
