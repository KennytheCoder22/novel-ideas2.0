...
function handleLeft() {
  ...
  async function handleCopyDiagnostics() {
    ...
    const sourceEnabledSummary = [
      ...
      `kitsuAlwaysFetch:${Boolean(lastDebugGcdDispatchTrace?.kitsuAlwaysFetch)}`,
      `kitsuBridgeMode:${Boolean(lastDebugGcdDispatchTrace?.kitsuBridgeMode)}`,
      ...
      `kitsuFacetMatchScore:${Array.isArray(lastDebugGcdDispatchTrace?.kitsuFacetMatchScore) && lastDebugGcdDispatchTrace.kitsuFacetMatchScore.length ? lastDebugGcdDispatchTrace.kitsuFacetMatchScore.join(" | ") : "(none)"}`,
      `kitsuIncludedBecause:${Array.isArray(lastDebugGcdDispatchTrace?.kitsuIncludedBecause) && lastDebugGcdDispatchTrace.kitsuIncludedBecause.length ? lastDebugGcdDispatchTrace.kitsuIncludedBecause.join(" | ") : "(none)"}`,
