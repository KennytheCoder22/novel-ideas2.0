...
function handleLeft() {
  ...
  function buildV2RecommendationResultForDiagnostics(v2Result: RecommendationResultV2, normalizedItems: RecItem[], inputWithHistory: RecommenderInput) {
    ...
    return {
      ...
      adultGoogleBooksAlignmentFailureCohortByTitle: (selectionDiagnostics?.adultGoogleBooksAlignmentFailureCohortByTitle || {}) as Record<string, string>,
      adultGoogleBooksAlignmentFailureCohortCount: (selectionDiagnostics?.adultGoogleBooksAlignmentFailureCohortCount || {}) as Record<string, number>,
      adultGoogleBooksAlignmentFailureCohortTitles: (selectionDiagnostics?.adultGoogleBooksAlignmentFailureCohortTitles || {}) as Record<string, string[]>,
      adultGoogleBooksAlignmentPassCohortByTitle: (selectionDiagnostics?.adultGoogleBooksAlignmentPassCohortByTitle || {}) as Record<string, string>,
      adultGoogleBooksAlignmentPassCohortCount: (selectionDiagnostics?.adultGoogleBooksAlignmentPassCohortCount || {}) as Record<string, number>,
      adultGoogleBooksAlignmentPassCohortTitles: (selectionDiagnostics?.adultGoogleBooksAlignmentPassCohortTitles || {}) as Record<string, string[]>,
      adultGoogleBooksRawSemanticTermsByTitle: (selectionDiagnostics?.adultGoogleBooksRawSemanticTermsByTitle || {}) as Record<string, string[]>,
      adultGoogleBooksSemanticTermsByMetadataFieldByTitle: (selectionDiagnostics?.adultGoogleBooksSemanticTermsByMetadataFieldByTitle || {}) as Record<string, Record<string, string[]>>,
      adultGoogleBooksFilteredGenericTermsByTitle: (selectionDiagnostics?.adultGoogleBooksFilteredGenericTermsByTitle || {}) as Record<string, string[]>,
      adultGoogleBooksCanonicalizedSemanticTermsByTitle: (selectionDiagnostics?.adultGoogleBooksCanonicalizedSemanticTermsByTitle || {}) as Record<string, string[]>,
      adultGoogleBooksUnmappedSemanticTermsByTitle: (selectionDiagnostics?.adultGoogleBooksUnmappedSemanticTermsByTitle || {}) as Record<string, string[]>,
      adultGoogleBooksFamilyDerivationEvidenceByTitle: (selectionDiagnostics?.adultGoogleBooksFamilyDerivationEvidenceByTitle || {}) as Record<string, Record<string, string[]>>,
      adultGoogleBooksFamilyDerivationFailureReasonByTitle: (selectionDiagnostics?.adultGoogleBooksFamilyDerivationFailureReasonByTitle || {}) as Record<string, string>,
      adultGoogleBooksQueryFamilyCounterfactualByTitle: (selectionDiagnostics?.adultGoogleBooksQueryFamilyCounterfactualByTitle || {}) as Record<string, string>,
      adultGoogleBooksQueryFamilyCounterfactualMatchedFamiliesByTitle: (selectionDiagnostics?.adultGoogleBooksQueryFamilyCounterfactualMatchedFamiliesByTitle || {}) as Record<string, string[]>,
      adultGoogleBooksQueryFamilyCounterfactualWouldPassByTitle: (selectionDiagnostics?.adultGoogleBooksQueryFamilyCounterfactualWouldPassByTitle || {}) as Record<string, boolean>,
      adultGoogleBooksQueryFamilyCounterfactualBlockedReasonByTitle: (selectionDiagnostics?.adultGoogleBooksQueryFamilyCounterfactualBlockedReasonByTitle || {}) as Record<string, string>,
      adultGoogleBooksQueryFamilyCounterfactualRescueCount: Number(selectionDiagnostics?.adultGoogleBooksQueryFamilyCounterfactualRescueCount || 0),
      adultGoogleBooksQueryFamilyCounterfactualRescueTitles: (selectionDiagnostics?.adultGoogleBooksQueryFamilyCounterfactualRescueTitles || []) as string[],
    };
  }
  ...
  async function handleCopyDiagnostics() {
    ...
    const sourceEnabledSummary = [
      ...
      `adultGoogleBooksAlignmentFailureCohortByTitle:${JSON.stringify((lastRecommendationResult as any)?.adultGoogleBooksAlignmentFailureCohortByTitle || {})}`,
      `adultGoogleBooksAlignmentFailureCohortCount:${JSON.stringify((lastRecommendationResult as any)?.adultGoogleBooksAlignmentFailureCohortCount || {})}`,
      `adultGoogleBooksAlignmentFailureCohortTitles:${JSON.stringify((lastRecommendationResult as any)?.adultGoogleBooksAlignmentFailureCohortTitles || {})}`,
      `adultGoogleBooksAlignmentPassCohortByTitle:${JSON.stringify((lastRecommendationResult as any)?.adultGoogleBooksAlignmentPassCohortByTitle || {})}`,
      `adultGoogleBooksAlignmentPassCohortCount:${JSON.stringify((lastRecommendationResult as any)?.adultGoogleBooksAlignmentPassCohortCount || {})}`,
      `adultGoogleBooksAlignmentPassCohortTitles:${JSON.stringify((lastRecommendationResult as any)?.adultGoogleBooksAlignmentPassCohortTitles || {})}`,
      `adultGoogleBooksRawSemanticTermsByTitle:${JSON.stringify((lastRecommendationResult as any)?.adultGoogleBooksRawSemanticTermsByTitle || {})}`,
      `adultGoogleBooksSemanticTermsByMetadataFieldByTitle:${JSON.stringify((lastRecommendationResult as any)?.adultGoogleBooksSemanticTermsByMetadataFieldByTitle || {})}`,
      `adultGoogleBooksFilteredGenericTermsByTitle:${JSON.stringify((lastRecommendationResult as any)?.adultGoogleBooksFilteredGenericTermsByTitle || {})}`,
      `adultGoogleBooksCanonicalizedSemanticTermsByTitle:${JSON.stringify((lastRecommendationResult as any)?.adultGoogleBooksCanonicalizedSemanticTermsByTitle || {})}`,
      `adultGoogleBooksUnmappedSemanticTermsByTitle:${JSON.stringify((lastRecommendationResult as any)?.adultGoogleBooksUnmappedSemanticTermsByTitle || {})}`,
      `adultGoogleBooksFamilyDerivationEvidenceByTitle:${JSON.stringify((lastRecommendationResult as any)?.adultGoogleBooksFamilyDerivationEvidenceByTitle || {})}`,
      `adultGoogleBooksFamilyDerivationFailureReasonByTitle:${JSON.stringify((lastRecommendationResult as any)?.adultGoogleBooksFamilyDerivationFailureReasonByTitle || {})}`,
      `adultGoogleBooksQueryFamilyCounterfactualByTitle:${JSON.stringify((lastRecommendationResult as any)?.adultGoogleBooksQueryFamilyCounterfactualByTitle || {})}`,
      `adultGoogleBooksQueryFamilyCounterfactualMatchedFamiliesByTitle:${JSON.stringify((lastRecommendationResult as any)?.adultGoogleBooksQueryFamilyCounterfactualMatchedFamiliesByTitle || {})}`,
      `adultGoogleBooksQueryFamilyCounterfactualWouldPassByTitle:${JSON.stringify((lastRecommendationResult as any)?.adultGoogleBooksQueryFamilyCounterfactualWouldPassByTitle || {})}`,
      `adultGoogleBooksQueryFamilyCounterfactualBlockedReasonByTitle:${JSON.stringify((lastRecommendationResult as any)?.adultGoogleBooksQueryFamilyCounterfactualBlockedReasonByTitle || {})}`,
      `adultGoogleBooksQueryFamilyCounterfactualRescueCount:${Number((lastRecommendationResult as any)?.adultGoogleBooksQueryFamilyCounterfactualRescueCount || 0)}`,
      `adultGoogleBooksQueryFamilyCounterfactualRescueTitles:${Array.isArray((lastRecommendationResult as any)?.adultGoogleBooksQueryFamilyCounterfactualRescueTitles) && (lastRecommendationResult as any).adultGoogleBooksQueryFamilyCounterfactualRescueTitles.length ? (lastRecommendationResult as any).adultGoogleBooksQueryFamilyCounterfactualRescueTitles.join(" | ") : "(none)"}`,
