...
function handleLeft() {
  ...
  async function handleCopyDiagnostics() {
    ...
    const sourceEnabledSummary = [
      ...
      `broadProfileBackfillTriggered:${Boolean((lastRecommendationResult as any)?.broadProfileBackfillTriggered)}`,
      `broadProfileBackfillSelected:${Array.isArray((lastRecommendationResult as any)?.broadProfileBackfillSelected) && (lastRecommendationResult as any).broadProfileBackfillSelected.length ? (lastRecommendationResult as any).broadProfileBackfillSelected.join(" | ") : "(none)"}`,
      `broadProfileBackfillRejectedReasons:${JSON.stringify((lastRecommendationResult as any)?.broadProfileBackfillRejectedReasons || {})}`,
      ...
      `cleanCandidateShortfallReason:${String((lastRecommendationResult as any)?.cleanCandidateShortfallReason || "none")}`,
      `expansionSeedQueries:${Array.isArray((lastRecommendationResult as any)?.expansionSeedQueries) && (lastRecommendationResult as any).expansionSeedQueries.length ? (lastRecommendationResult as any).expansionSeedQueries.join(" | ") : "(none)"}`,
