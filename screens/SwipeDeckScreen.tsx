...
function handleLeft() {
  ...
  function buildV2RecommendationResultForDiagnostics(v2Result: RecommendationResultV2, normalizedItems: RecItem[], inputWithHistory: RecommenderInput) {
    ...
    return {
      ...
      adultGoogleBooksProductionSuppressionRuleHistogram: (selectionDiagnostics?.adultGoogleBooksProductionSuppressionRuleHistogram || {}) as Record<string, number>,
      adultGoogleBooksProductionSuppressedCandidatesByRule: (selectionDiagnostics?.adultGoogleBooksProductionSuppressedCandidatesByRule || {}) as Record<string, string[]>,
      adultGoogleBooksProductionSuppressedFamiliesByTitle: (selectionDiagnostics?.adultGoogleBooksProductionSuppressedFamiliesByTitle || {}) as Record<string, string[]>,
      adultGoogleBooksProductionSuppressionDetailsByTitle: (selectionDiagnostics?.adultGoogleBooksProductionSuppressionDetailsByTitle || {}) as Record<string, unknown[]>,
    };
  }
  ...
  async function handleCopyDiagnostics() {
    ...
    const sourceEnabledSummary = [
      ...
      `adultGoogleBooksProductionSuppressionRuleHistogram:${JSON.stringify((lastRecommendationResult as any)?.adultGoogleBooksProductionSuppressionRuleHistogram || {})}`,
      `adultGoogleBooksProductionSuppressedCandidatesByRule:${JSON.stringify((lastRecommendationResult as any)?.adultGoogleBooksProductionSuppressedCandidatesByRule || {})}`,
      `adultGoogleBooksProductionSuppressedFamiliesByTitle:${JSON.stringify((lastRecommendationResult as any)?.adultGoogleBooksProductionSuppressedFamiliesByTitle || {})}`,
      `adultGoogleBooksProductionSuppressionDetailsByTitle:${JSON.stringify((lastRecommendationResult as any)?.adultGoogleBooksProductionSuppressionDetailsByTitle || {})}`,
