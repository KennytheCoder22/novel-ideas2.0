...
async function main() {
  ...
  try {
    ...
    assertDeepEqual(middleGradesHumorRetryFetchCalls, ["middle grade humor", "funny fantasy", "middle grade school story"], "middle grades humor retry should rotate away from repeated middle grade humor");
