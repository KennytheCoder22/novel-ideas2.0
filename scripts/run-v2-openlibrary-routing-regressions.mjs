...
async function main() {
  ...
  try {
    ...
    assertDeepEqual(middleGradesHumorRetryFetchCalls, ["middle grade humor", "funny fantasy", "middle grade adventure"], "middle grades humor retry should rotate away from repeated middle grade humor");
