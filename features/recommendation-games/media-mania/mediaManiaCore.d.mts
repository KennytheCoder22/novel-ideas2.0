...
export type MediaManiaCatalogItem = { id: string; source: string; mediaSource: MediaManiaSource; title: string; creator?: string; imageUri?: string; imageOrigin?: "deck" | "static_map"; wikiTitle?: string; traitKeys?: string[] };
export type ItemSnapshot = { id: string; source: string; mediaSource: MediaManiaSource; title: string; creator: string };
export type MediaManiaRound = { id: string; roundNumber: number; roundType: "LIKE" | "DISLIKE"; startedAtMs: number; activeSources: MediaManiaSource[]; basisItems: MediaManiaCatalogItem[]; visiblePositiveContext: ItemSnapshot[]; visibleNegativeContext: ItemSnapshot[]; candidates: MediaManiaCatalogItem[]; presentationOrder: string[]; candidateStrategyId: string; isCrossMedia: boolean };
...
export function createMediaManiaState(input: { playerId: string; sessionId: string; nowMs?: number }): MediaManiaState;
