...
function teenOpenLibraryMeaningfulTasteEligibility(candidate, profile) {
    if (profile.ageBand !== "teens" || candidate.source !== "openLibrary")
        return { allowed: true, signals: [], nonTitleSignals: [] };
    ...
    if (positiveTasteScore <= 0)
        return { allowed: false, reason: "teen_openlibrary_no_positive_metadata_taste", signals: likedSignals, nonTitleSignals: [] };
    if (!likedSignals.length)
        return { allowed: false, reason: "teen_openlibrary_no_metadata_liked_signals", signals: likedSignals, nonTitleSignals: [] };
    const meaningfulSignals = likedSignals.filter((signal) => !TEEN_OPENLIBRARY_GENERIC_TASTE_SIGNAL.test(signal));
    if (!meaningfulSignals.length)
        return { allowed: false, reason: "teen_openlibrary_generic_only_metadata_taste", signals: likedSignals, nonTitleSignals: [] };
    ...
    if (!nonTitleMeaningfulSignals.length)
        return { allowed: false, reason: "teen_openlibrary_title_only_metadata_taste", signals: likedSignals, nonTitleSignals: [] };
    ...
    if (!hasAllowedTasteEvidence)
        return { allowed: false, reason: "teen_openlibrary_single_broad_metadata_taste", signals: likedSignals, nonTitleSignals: nonTitleMeaningfulSignals };
