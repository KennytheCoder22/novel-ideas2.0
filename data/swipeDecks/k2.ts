...
export const k2: SwipeDeck = {
  ...
  cards: [
    ...
    { isDefault: true, title: "Don’t Let the Pigeon Drive the Bus!", author: "Mo Willems", genre: "Humor", wikiTitle: "Don't Let the Pigeon Drive the Bus!", tags: ["audience:children", "age:k2", "format:picture_book", "genre:humor", "vibe:silly"] },
    { isDefault: true, title: "There’s a Monster at the End of This Book", author: "Jon Stone", genre: "Humor / Classic", wikiTitle: "The Monster at the End of This Book", tags: ["audience:children", "age:k2", "format:picture_book", "genre:humor", "vibe:meta"] },
    ...
    { isDefault: true, title: "How Do Dinosaurs Say Goodnight?", author: "Jane Yolen", genre: "Dinosaurs / Bedtime", wikiTitle: "How Do Dinosaurs Say Goodnight?", tags: ["audience:children", "age:k2", "format:picture_book", "topic:dinosaurs", "genre:bedtime", "vibe:warm"] },
    { isDefault: true, title: "First Big Book of Animals", author: "Catherine D. Hughes", genre: "Animals / Nonfiction", wikiTitle: "National Geographic Little Kids First Big Book of Animals", tags: ["audience:children", "age:k2", "format:nonfiction", "genre:animals"] },
    { isDefault: true, title: "Goodnight, Goodnight, Construction Site", author: "Sherri Duskey Rinker", genre: "Vehicles / Bedtime", wikiTitle: "Goodnight, Goodnight, Construction Site", tags: ["audience:children", "age:k2", "format:picture_book", "topic:vehicles", "genre:bedtime", "vibe:calm"] },
    { isDefault: true, title: "The Color Monster", author: "Anna Llenas", genre: "SEL / Feelings", wikiTitle: "The Colour Monster", tags: ["audience:children", "age:k2", "format:picture_book", "topic:feelings", "vibe:gentle"] },
    { isDefault: true, title: "The Invisible String", author: "Patrice Karst", genre: "SEL / Family", wikiTitle: "The Invisible String", tags: ["audience:children", "age:k2", "format:picture_book", "topic:family", "topic:feelings", "vibe:cozy"] },
    { isDefault: true, title: "Not a Box", author: "Antoinette Portis", genre: "Imagination", wikiTitle: "Not a Box", tags: ["audience:children", "age:k2", "format:picture_book"] },
    { isDefault: true, title: "I Am a Frog!", author: "Mo Willems", genre: "Early Reader / Humor", wikiTitle: "I Am a Frog!", tags: ["audience:children", "age:k2", "format:early_reader", "genre:humor", "vibe:friendship"] },
    { isDefault: true, title: "Pete the Cat and the Missing Cupcakes", author: "Kimberly & James Dean", genre: "Character / Mystery-lite", wikiTitle: "Pete the Cat and the Missing Cupcakes", tags: ["audience:children", "age:k2", "format:picture_book", "genre:mystery", "vibe:playful"] },
    ...
    { isDefault: true, title: "Mister Rogers’ Neighborhood", imageUri: "https://m.media-amazon.com/images/M/MV5BNGQ3ZWFkZDMtNjlmNC00NWNmLWJlYzctMDlkZDdiNDBiZTgxXkEyXkFqcGc@._V1_.jpg", author: "PBS", genre: "Feelings / Kindness / Calm", wikiTitle: "Mister Rogers' Neighborhood", tags: ["audience:children", "age:k2", "media:tv", "genre:feelings", "genre:kindness", "genre:calm", "format:series"] },
    { isDefault: true, title: "StoryBots", imageUri: "https://m.media-amazon.com/images/M/MV5BYTBlYjhhYWYtMjcwMi00YTZiLThlNmMtOWJjNjVlY2JjMjQwXkEyXkFqcGc@._V1_.jpg", author: "Netflix", genre: "Science / Curiosity / Humor", wikiTitle: "Ask the StoryBots", tags: ["audience:children", "age:k2","media:tv","genre:science_fiction","genre:humor","format:series"] },
    ...
    { isDefault: true, title: "Elephant & Piggie: My New Friend Is So Fun!", author: "Mo Willems", genre: "friendship", wikiTitle: "My New Friend Is So Fun!", tags: ["media:book", "layout:older", "genre:friendship", "vibe:funny", "vibe:everyday", "vibe:gentle", "format:Early Reader", "audience:children", "age:k2"] },
