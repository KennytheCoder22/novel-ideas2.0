...
const CANON_MSHS_GAMES: any[] = [
 ...
 output: {
  ...
  { isDefault: true, title: "Fortnite", semantic: { contentTraits: ["competition","survival","media_spectacle"], toneTraits: ["energetic","fast","playful"], characterTraits: ["team_players"], storyTraits: ["competition_progression","survival_scenario"], aversionTraits: ["overstimulating"] }, author: "Epic Games", genre: "Battle Royale", wikiTitle: "Fortnite", tags: ["audience:teen","age:mshs","media:game","survival","energetic","fast-paced","playful"],
 output: {
   genre: ["survival"],
 ...
 output: {
  ...
  { isDefault: true, title: "The Elder Scrolls V: Skyrim", semantic: { contentTraits: ["adventure","magic","power"], toneTraits: ["immersive","adventurous","grand"], characterTraits: ["outsider_hero"], storyTraits: ["quest_structure","exploration_arc"], aversionTraits: ["worldbuilding_density"] }, author: "Bethesda", genre: "Fantasy / Open World", wikiTitle: "The Elder Scrolls V: Skyrim", tags: ["audience:teen","age:mshs","media:game","fantasy","adventure"],
 output: {
   genre: ["fantasy", "adventure"],
   vibes: [],
 }, },
 ...
 output: {
  ...
  { isDefault: true, title: "Slay the Spire", semantic: { contentTraits: ["magic","competition","power_mastery"], toneTraits: ["focused","smart","dark"], characterTraits: ["underestimated_protagonist"], storyTraits: ["battle_progression","power_awakening"], aversionTraits: ["repetition","difficulty"] }, author: "Mega Crit", genre: "Fantasy / Strategy", wikiTitle: "Slay the Spire", tags: ["audience:teen","age:mshs","media:game","fantasy","dark"],
 output: {
   genre: ["fantasy"],
   vibes: ["dark"],
 }, },
  { isDefault: true, title: "Overwatch 2", semantic: { contentTraits: ["competition","superpowered_family","community"], toneTraits: ["energetic","fast","playful"], characterTraits: ["found_family_team"], storyTraits: ["team_building","competition_progression"], aversionTraits: ["overstimulating"] }, author: "Blizzard", genre: "Hero Shooter", wikiTitle: "Overwatch 2", tags: ["audience:teen","age:mshs","media:game","superheroes","community","energetic","fast-paced","playful"],
 output: {
   genre: ["superheroes", "community"],
   vibes: ["energetic", "fast-paced", "playful"],
 }, },
  { isDefault: true, title: "Unpacking", semantic: { contentTraits: ["family","identity","human_connection"], toneTraits: ["gentle","quiet","warm"], characterTraits: ["sensitive_protagonist"], storyTraits: ["building_a_new_life","life_story_reveal"], aversionTraits: ["low_plot"] }, author: "Witch Beam", genre: "Cozy / Puzzle", wikiTitle: "Unpacking (video game)", tags: ["audience:teen","age:mshs","media:game","cozy","family","identity","human connection","gentle","warm"],
 output: {
   genre: ["family", "identity"],
   vibes: ["cozy", "human connection", "gentle", "warm"],
 }, },
  { isDefault: true, title: "Animal Crossing: New Horizons", semantic: { contentTraits: ["community","friendship","family"], toneTraits: ["cozy","gentle","warm"], characterTraits: ["gentle_caretaker"], storyTraits: ["building_a_new_life","relationship_building"], aversionTraits: ["slow_pacing","low_conflict"] }, author: "Nintendo", genre: "Cozy / Simulation", wikiTitle: "Animal Crossing: New Horizons", tags: ["audience:teen","age:mshs","media:game","cozy","community","friendship","family","gentle","warm"],
 output: {
   genre: ["community", "friendship", "family"],
   vibes: ["cozy", "gentle", "warm"],
 }, },
  { isDefault: true, title: "Splatoon 3", semantic: { contentTraits: ["competition","community","friendship"], toneTraits: ["energetic","playful","fast"], characterTraits: ["team_players"], storyTraits: ["competition_progression","team_building"], aversionTraits: ["overstimulating"] }, author: "Nintendo", genre: "Action / Competition", wikiTitle: "Splatoon 3", tags: ["audience:teen","age:mshs","media:game","fast-paced","community","friendship","energetic","playful"],
 output: {
   genre: ["community", "friendship"],
   vibes: ["fast-paced", "energetic", "playful"],
 }, },
  { isDefault: true, title: "Night in the Woods", semantic: { contentTraits: ["small_town","identity","mental_health"], toneTraits: ["quirky","melancholic","thoughtful"], characterTraits: ["flawed_but_relatable"], storyTraits: ["coming_of_age","relationship_building"], aversionTraits: ["slow_pacing"] }, author: "Infinite Fall", genre: "Narrative / Mystery", wikiTitle: "Night in the Woods", tags: ["audience:teen","age:mshs","media:game","mystery","drama","identity","vulnerability","quirky","melancholic"],
 output: {
   genre: ["mystery", "drama", "identity", "vulnerability"],
   vibes: ["quirky", "melancholic"],
 }, },
  { isDefault: true, title: "Sea of Stars", semantic: { contentTraits: ["adventure","friendship","destiny"], toneTraits: ["adventurous","warm","grand"], characterTraits: ["young_heroes"], storyTraits: ["quest_journey","team_growth"], aversionTraits: ["predictable_tropes"] }, author: "Sabotage Studio", genre: "Fantasy / Adventure", wikiTitle: "Sea of Stars", tags: ["audience:teen","age:mshs","media:game","fantasy","adventure","friendship","warm"],
 output: {
   genre: ["fantasy", "adventure", "friendship"],
   vibes: ["warm"],
 }, },
  { isDefault: true, title: "Hi-Fi Rush", semantic: { contentTraits: ["music_and_storytelling","rebellion","friendship"], toneTraits: ["playful","energetic","stylish"], characterTraits: ["lovable_misfits"], storyTraits: ["team_building","rebellion_against_society"], aversionTraits: ["overstimulating"] }, author: "Tango Gameworks", genre: "Action / Comedy", wikiTitle: "Hi-Fi Rush", tags: ["audience:teen","age:mshs","media:game","comedy","fast-paced","friendship","playful","energetic","atmospheric"],
 output: {
   genre: ["comedy", "friendship"],
   vibes: ["fast-paced", "playful", "energetic", "atmospheric"],
 }, },
  { isDefault: true, title: "Marvel's Guardians of the Galaxy", semantic: { contentTraits: ["found_family","space_politics","human_connection"], toneTraits: ["funny","adventurous","heartfelt"], characterTraits: ["leader_with_loyal_crew"], storyTraits: ["save_the_galaxy_arc","team_building"], aversionTraits: ["predictable_beats"] }, author: "Square Enix", genre: "Science Fiction / Adventure", wikiTitle: "Marvel's Guardians of the Galaxy", tags: ["audience:teen","age:mshs","media:game","science fiction","adventure","family","human connection","comedy"],
 output: {
...
const CANON_MSHS_ANIME: any[] = [
 ...
 output: {
  ...
  { isDefault: true, title: "Demon Slayer: Kimetsu no Yaiba", semantic: { contentTraits: ["monster_hunting","family","training"], toneTraits: ["dramatic","emotional","adventurous"], characterTraits: ["resilient_protagonist"], storyTraits: ["quest_journey","battle_progression"], aversionTraits: ["violence","emotional_heaviness"] }, author: "Anime", genre: "Paranormal / Adventure", wikiTitle: "Demon Slayer: Kimetsu no Yaiba", tags: ["audience:teen","age:mshs","media:anime","adventure","spooky","family","emotional growth"],
 output: {
   genre: ["adventure", "family"],
   vibes: ["spooky", "emotional growth"],
 }, },
  { isDefault: true, title: "Jujutsu Kaisen", semantic: { contentTraits: ["monsters","high_school","training"], toneTraits: ["dark","fast","funny"], characterTraits: ["young_heroes"], storyTraits: ["training_arc","battle_progression"], aversionTraits: ["violence","overstimulating"] }, author: "Anime", genre: "Paranormal / Horror", wikiTitle: "Jujutsu Kaisen", tags: ["audience:teen","age:mshs","media:anime","horror","spooky","school","dark","fast-paced","comedy"],
 output: {
   genre: ["horror", "school", "comedy"],
   vibes: ["spooky", "dark", "fast-paced"],
 }, },
  { isDefault: true, title: "Fullmetal Alchemist: Brotherhood", semantic: { contentTraits: ["family","artificial_life","political_intrigue"], toneTraits: ["dramatic","adventurous","emotional"], characterTraits: ["loyal_siblings"], storyTraits: ["quest_journey","truth_discovery"], aversionTraits: ["violence","complex_themes"] }, author: "Anime", genre: "Fantasy / Adventure", wikiTitle: "Fullmetal Alchemist: Brotherhood", tags: ["audience:teen","age:mshs","media:anime","fantasy","adventure","family","robots","political","emotional growth"],
 output: {
   genre: ["fantasy", "adventure", "family", "robots", "political"],
   vibes: ["emotional growth"],
 }, },
  { isDefault: true, title: "Code Geass", semantic: { contentTraits: ["war","rebellion","deception"], toneTraits: ["intense","smart"], characterTraits: ["antihero_lead"], storyTraits: ["resistance_story","power_struggle"], aversionTraits: ["moral_ambiguity"] }, author: "Anime", genre: "Science Fiction / Dystopian", wikiTitle: "Code Geass", tags: ["audience:teen","age:mshs","media:anime","science fiction","dystopian","war & society"],
 output: {
 ...
 output: {
  ...
  { isDefault: true, title: "Sword Art Online", semantic: { contentTraits: ["virtual_world","survival_game","romance"], toneTraits: ["fast","dramatic","adventurous"], characterTraits: ["eager_hero"], storyTraits: ["survival_story","quest_structure"], aversionTraits: ["predictable_tropes"] }, author: "Anime", genre: "Science Fiction / Adventure", wikiTitle: "Sword Art Online", tags: ["audience:teen","age:mshs","media:anime","science fiction","adventure","survival","romance","fast-paced"],
 output: {
   genre: ["science fiction", "adventure", "survival", "romance"],
   vibes: ["fast-paced"],
 }, },
  { isDefault: true, title: "Bleach", semantic: { contentTraits: ["monsters","high_school","power"], toneTraits: ["stylish","fast","adventurous"], characterTraits: ["reluctant_hero"], storyTraits: ["coming_into_power","battle_progression"], aversionTraits: ["repetition"] }, author: "Anime", genre: "Paranormal / Adventure", wikiTitle: "Bleach (TV series)", tags: ["audience:teen","age:mshs","media:anime","adventure","spooky","school","atmospheric","fast-paced"],
 output: {
   genre: ["adventure", "school"],
   vibes: ["spooky", "atmospheric", "fast-paced"],
 }, },
  { isDefault: true, title: "Naruto", semantic: { contentTraits: ["training","friendship","outsider_identity"], toneTraits: ["hopeful","energetic","fun"], characterTraits: ["determined_underdog"], storyTraits: ["training_arc","coming_of_age"], aversionTraits: ["repetition"] }, author: "Anime", genre: "Adventure / Fantasy", wikiTitle: "Naruto", tags: ["audience:teen","age:mshs","media:anime","adventure","fantasy","friendship","outsider","hopeful","energetic","playful"],
 output: {
   genre: ["adventure", "fantasy", "friendship", "outsider"],
   vibes: ["hopeful", "energetic", "playful"],
 }, },
  { isDefault: true, title: "One Piece", semantic: { contentTraits: ["pirate_adventure","friendship","treasure_hunt"], toneTraits: ["fun","adventurous","playful"], characterTraits: ["optimistic_leader"], storyTraits: ["island_quests","team_building"], aversionTraits: ["length"] }, author: "Anime", genre: "Adventure / Fantasy", wikiTitle: "One Piece", tags: ["audience:teen","age:mshs","media:anime","adventure","fantasy","friendship","treasure","playful"],
 output: {
   genre: ["adventure", "fantasy", "friendship", "treasure"],
   vibes: ["playful"],
 }, },
  { isDefault: true, title: "Haikyu!!", semantic: { contentTraits: ["sports_team","competition","friendship"], toneTraits: ["energetic","hopeful","fun"], characterTraits: ["young_athletes"], storyTraits: ["competition_progression","team_growth"], aversionTraits: ["sports_focus"] }, author: "Anime", genre: "Sports", wikiTitle: "Haikyu!!", tags: ["audience:teen","age:mshs","media:anime","energetic","community","friendship","hopeful","playful"],
 output: {
   genre: ["community", "friendship"],
