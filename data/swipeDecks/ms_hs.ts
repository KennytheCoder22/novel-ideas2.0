...
const CANON_MSHS_MOVIES: any[] = [
 ...
 output: {
  ...
  { isDefault: true, title: "Spider-Man: Into the Spider-Verse", semantic: { contentTraits: ["multiverse","secret_identity","identity"], toneTraits: ["energetic","inspiring"], characterTraits: ["reluctant_hero","mentor_figures"], storyTraits: ["coming_of_age","team_up"], aversionTraits: ["overstimulating"] }, author: "Sony", genre: "Illustrated / Superhero", wikiTitle: "Spider-Man: Into the Spider-Verse", tags: ["audience:teen","age:mshs","media:movie","superheroes","film","illustrated","science fiction","identity","energetic","uplifting"],tasteTraits: { warmth: 0.66, darkness: 0.0, pacing: 1, realism: -1, characterFocus: 1, ideaDensity: 0.77 }, 
 output: {
