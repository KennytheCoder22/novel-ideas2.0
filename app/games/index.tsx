...
const GAME_CARDS: GameCardConfig[] = [
  ...
  },
  {
    ...
    duration: "4–7 min",
    whatYouDo: "Choose and rank real-book synopses with blurred covers, then reveal your finalists.",
    whatLearns: "Learns which story premises you prefer before revealing titles and authors.",
    icon: "tournament",
