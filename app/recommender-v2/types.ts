...
export interface SourceFetchDiagnosticV2 {
  ...
  requestNotDispatchedReason?: string;
  requestUrl?: string;
...
export interface SourceDiagnosticV2 {
  ...
  queryAttemptedCount?: number;
  requestDispatchedCount?: number;
  requestCompletedCount?: number;
  requestAbortedCount?: number;
  requestTimedOutCount?: number;
  requestNeverDispatchedCount?: number;
  upstreamErrorCount?: number;
  validEmptyResponseCount?: number;
  conversionRemovedAllRowsCount?: number;
  normalizationRemovedAllRowsCount?: number;
  ...
  preteenGoogleBooksPublicationShapeNarrativeEvidenceByTitle?: Record<string, string[]>;
  preteenGoogleBooksPublicationShapeArtifactEvidenceByTitle?: Record<string, string[]>;
  preteenGoogleBooksPublicationShapeCounterfactualDecisionByTitle?: Record<string, string>;
  preteenGoogleBooksPublicationShapeLikelyFalseRejectTitles?: string[];
  preteenGoogleBooksPublicationShapeLikelyCorrectRejectTitles?: string[];
  ...
  kidsGoogleBooksRecommendationIdentityByTitle?: Record<string, string>;
  kidsGoogleBooksRecommendationIdentityEvidenceByTitle?: Record<string, string[]>;
  kidsGoogleBooksSinglePublicationEvidenceByTitle?: Record<string, string[]>;
  kidsGoogleBooksCollectionEvidenceByTitle?: Record<string, string[]>;
  kidsGoogleBooksMarketingKeywordEvidenceByTitle?: Record<string, string[]>;
  kidsGoogleBooksTrustedIdentityFieldsByTitle?: Record<string, string[]>;
  kidsGoogleBooksIdentityDecisionByTitle?: Record<string, string>;
  kidsGoogleBooksIdentityRejectionReasonByTitle?: Record<string, string>;
  kidsGoogleBooksCollectionRejectedTitles?: string[];
  kidsGoogleBooksGenericBundleRejectedTitles?: string[];
  kidsGoogleBooksSingleStoryAcceptedTitles?: string[];
  kidsGoogleBooksAmbiguousIdentityTitles?: string[];
  kidsGoogleBooksAudienceFormatGateDecisionByTitle?: Record<string, string>;
  kidsGoogleBooksCleanFinalGateDecisionByTitle?: Record<string, string>;
  kidsGoogleBooksCleanFinalGateEvidenceByTitle?: Record<string, string[]>;
  kidsGoogleBooksGateSequenceByTitle?: Record<string, string>;
  kidsGoogleBooksSuppressedFamilyDetailsByFamily?: Record<string, { blockedBy: string[]; likeBackedRows: number; noLikeBackedRows: number }>;
  ...
  teenGoogleBooksPublicationIdentityDecision?: string;
  teenGoogleBooksPublicationIdentityReason?: string;
  teenGoogleBooksPublicationIdentityClassification?: string;
  teenGoogleBooksPublicationIdentityEvidence?: string[];
  teenGoogleBooksPublicationIdentityDecisionByTitle?: Record<string, string>;
  teenGoogleBooksPublicationIdentityReasonByTitle?: Record<string, string>;
  teenGoogleBooksPublicationIdentityClassificationByTitle?: Record<string, string>;
  teenGoogleBooksPublicationIdentityEvidenceByTitle?: Record<string, string[]>;
  teenGoogleBooksMeaningfulTasteClassification?: string;
  teenGoogleBooksNetMeaningfulAlignmentScore?: number;
  teenGoogleBooksWouldPassWithoutQueryDerivedEvidence?: boolean;
  teenGoogleBooksSignalFieldMatches?: Record<string, string[]>;
  teenGoogleBooksCategoryOnlySignals?: string[];
  teenGoogleBooksQueryFamilyOnlySignals?: string[];
  teenGoogleBooksBroadToneOnly?: boolean;
  teenGoogleBooksSelectedFinal?: boolean;
  teenGoogleBooksSignalFieldsByTitle?: Record<string, Record<string, string[]>>;
  teenGoogleBooksGenreSignalsByTitle?: Record<string, string[]>;
  teenGoogleBooksThemeSignalsByTitle?: Record<string, string[]>;
  ...
  teenGoogleBooksMeaningfulTasteClassificationByTitle?: Record<string, string>;
  teenGoogleBooksMeaningfulTasteClassificationHistogram?: Record<string, number>;
  teenGoogleBooksMeaningfulTasteStrongMatches?: string[];
  teenGoogleBooksMeaningfulTasteDefensibleSecondaryMatches?: string[];
