...
export interface SourceDiagnosticV2 {
  ...
  googleBooksAverageRatingByTitle?: Record<string, number>;
  ...
  adultPostFinalRecoveryTriggered?: boolean;
  adultPostFinalRecoveryInitialCleanCount?: number;
  adultPostFinalRecoveryTargetCount?: number;
  adultPostFinalRecoveryLikedFamilyWeights?: Record<string, number>;
  adultPostFinalRecoveryLikedItemCountsByFamily?: Record<string, number>;
  adultPostFinalRecoveryGeneratedCandidates?: Array<Record<string, unknown>>;
  adultPostFinalRecoveryCandidatePrimaryFamily?: Record<string, string>;
  adultPostFinalRecoveryRemovedAlreadyAttempted?: string[];
  adultPostFinalRecoveryBestQueryByFamily?: Record<string, string>;
  adultPostFinalRecoverySelectedDistinctFamilies?: string[];
  adultPostFinalRecoverySecondaryVariantsUsed?: string[];
  adultPostFinalRecoveryFinalQueries?: string[];
  adultPostFinalRecoveryQueriesAttempted?: string[];
  adultPostFinalRecoveryFetchResultsByQuery?: Record<string, number>;
  adultPostFinalRecoveryFetchedRawCountByQuery?: Record<string, number>;
  adultPostFinalRecoveryConvertedCountByQuery?: Record<string, number>;
  adultPostFinalRecoveryMergedCandidateCount?: number;
  adultPostFinalRecoveryMergedTitles?: string[];
  adultPostFinalRecoveryAcceptedTitles?: string[];
  adultPostFinalRecoveryRejectedByReason?: Record<string, string[]>;
  adultPostFinalRecoveryPreservedInitialTitles?: string[];
  adultPostFinalRecoveryMissingInitialTitles?: string[];
  adultPostFinalRecoveryNoWorseningGuardPassed?: boolean;
  adultPostFinalRecoveryRolledBackQueries?: string[];
  adultPostFinalRecoveryFinalCleanCount?: number;
  adultPostFinalRecoveryStoppedReason?: string;
  ...
  expansionAttemptedQueries?: string[];
