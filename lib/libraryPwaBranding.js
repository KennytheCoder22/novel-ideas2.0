...
function libraryPwaThemeColor(config) {
...
function libraryPwaName(config, libraryId) {
...
function libraryPwaShortName(config, libraryId) {
...
function readLibraryLogoBuffer(config) {
  const branding = record(record(config).branding);
...
function libraryPwaIconVersion(config, logoBuffer) {
...
function buildHostedLibraryManifest(config, libraryId, options = {}) {
...
async function renderLibraryPwaIcon(logoBuffer, size, purpose, background) {
